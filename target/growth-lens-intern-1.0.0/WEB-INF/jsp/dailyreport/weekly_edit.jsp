...
<head>
    ...
    <title>GrowthLens Intern - 编辑周报</title>
...
<body>
                    ...
                    <div class="card-body">
                        <form id="weeklyForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="weekYear" name="weekYear" value="${report.weekYear}" required>
                            </div>
                            <div class="form-group">
                                <label for="weekNum">周次</label>
                                <input type="number" class="form-control" id="weekNum" name="weekNum" value="${report.weekNum}" min="1" max="53" required>
                            </div>
                            <div class="week-info">
                                <strong>本周日期范围：</strong>
                                <span id="dateRange">${report.startDate} ~ ${report.endDate}</span>
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="weekSummary" name="weekSummary" rows="6" placeholder="请输入本周工作总结...">${report.weekSummary}</textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="problemReview" name="problemReview" rows="4" placeholder="请输入本周遇到的问题及复盘...">${report.problemReview}</textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="nextWeekPlan" name="nextWeekPlan" rows="4" placeholder="请输入下周工作计划...">${report.nextWeekPlan}</textarea>
                            </div>
                            <div class="mt-4">
    ...
    <script>
        ...
        function saveDraft() {
            ...
            fetch(ctxPath + '/dailyreport/weekly/update', {
                method: 'POST',
                body: formData
            }).then(function(response) {
                return response.json();

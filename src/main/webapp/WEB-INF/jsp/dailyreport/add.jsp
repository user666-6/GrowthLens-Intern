...
<head>
    ...
    <title>GrowthLens Intern - 新增日报</title>
...
<body>
    <div class="d-flex">
        ...
        <div class="flex-grow-1">
            ...
            <div class="main-content">
                <div class="card">
                    <div class="card-header">新增日报</div>
                    <div class="card-body">
                        <form id="dailyForm">
                            <div class="form-group">
                                <label for="reportDate">日报日期</label>
                                <input type="date" class="form-control" id="reportDate" name="reportDate" value="${reportDate}" required>
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="todayFinish" name="todayFinish" rows="4" placeholder="请输入今日完成的工作内容..."></textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="encounterProblem" name="encounterProblem" rows="3" placeholder="请输入工作中遇到的问题..."></textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="tomorrowPlan" name="tomorrowPlan" rows="3" placeholder="请输入明日工作计划..."></textarea>
                            </div>
                            <div class="mt-4">
    ...
    <script>
        ...
        function saveDraft() {
            ...
            fetch(ctxPath + '/dailyreport/draft', {
                method: 'POST',
                body: formData
            }).then(function(response) {
                return response.json();
        ...
        function submitReport() {
            ...
            fetch(ctxPath + '/dailyreport/save', {
                method: 'POST',
                body: formData
            }).then(function(response) {
                return response.json();
